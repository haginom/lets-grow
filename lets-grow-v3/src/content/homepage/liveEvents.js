...
const LiveEvents = ({ data }) => {
  ...
  `);
  return (
    <FullWidthPanel colours="white bg-blue" image={data.bunting.childImageSharp.gatsbyImageData} top="-3.6rem" left="36rem" maxWidth="58rem">
      <div className="flex items-center">
          <GatsbyImage 
            alt="logo"
            image={logoData.logo.childImageSharp.gatsbyImageData}/>
          <StyledSubHeading className="letsgrowfont self-start">Let's Grow Live Events</StyledSubHeading>
      </div>
      ...
      <StyledLayout>
        <TextContainer id="textContainer">
          ...
          <Paragraph>
          From stage shows of any size, to creative workshops and pop-up installations, our super-inventive team can curate a live event to suit your setting.
          </Paragraph>
          <Paragraph>
            We guarantee to delight audiences of every age with our family of baby fruit and veg, looked after by the lovely Let’s Grow Nannies and Mr. Bloom!
          </Paragraph>
          </TextContainer>
        <div id="vidContainer" >
          <FloatingVideo poster={mrBloomPoster} source={mrBloomVideo} direction="right"/>
        </div>
      </StyledLayout>
      ...
      <SpeechBubbles 
        ...
        inner = {<InnerWrapper 
                  ...
                  quote={"“Magical and imaginative, family friendly theatre at its very finest!”"} 
      ...
      <StyledPhotoGallery className="mb2 relative mw8">   
        <GatsbyImage
          ...
          className="dn db-l"
          style={{top:"-250px", width: 460, position: "absolute", right:"-70px"}}
      ...
      <StyledLastSection >
        ...
        inner = {<InnerWrapper 
                  ...
                  mtxs={"-1rem"}
                  direction={"rotate(0.5deg)"} 
                  quote={"“From concept to design, creation to execution - this team will pull out all the stops to bring fantastic dreams to life using their skills, vision and attention to detail.”"} 
