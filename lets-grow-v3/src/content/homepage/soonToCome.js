    ...
    <FullWidthPanel colours="white bg-light-yellow" maxWidth="57rem">
      <StyledLayout>
        <StyledSubHeading  className="letsgrowfont ttn ml4-l">
          Soon to come! Two more additions to our collection of offers. Online resources for arts, cultural and community organisations and parents and carers at home:
        </StyledSubHeading>
      </StyledLayout>
      <StyledSecondLayout className="flex flex-wrap mt4-ns mb4-ns">
        <StyledFlex className="b--white bg-orange bw2-l pa4 pt0 mb2 mb1-l ma3 br4">
          ...
          <StyledParagraph className="white center">
            For arts, cultural and community organisations. Flexible workshops and activities which are super family-friendly.
          </StyledParagraph>
