...
import { StyledEventContainer, StyledTitle, StyledTag, ButtonContainer, Paragraph} from "../../components/styled/eventTypeStyles";
      ...
      <Rows wrap="wrap-reverse" className="mt4">
        <TextWrapper>
          <Paragraph className="fw6">
            All the fabulous musical hits from Mr. Bloom’s well-loved TV shows as well as numerous cheeky covers and banter. Audiences love to participate!
          </Paragraph>
          <Paragraph >
            At the end of a long day’s gardening, once the veggies are asleep, Mr. Bloom loves to get together with his musical friends on the allotment and play some songs.
          </Paragraph>
          <Paragraph>
            Our headline show is typically 45-60 minutes long and features Mr. Bloom and his band of merry gardeners, Peggy the dancing broad bean and our array of giant inflatable vegetables.
          </Paragraph>
          <Paragraph >
            Mr. Bloom meet and greets can also be arranged!
          </Paragraph>
        </TextWrapper>
        <ImgContainer>
          <RoundedImg
      ...
      <StyledEventContainer className="flex flex-wrap" gap="1rem">
        ...
        <SecondColumn>
          ...
          <TextWrapper mw="380px" mb="1rem" className="mt2">
            <Paragraph className="fw6">
              Mr. Bloom, CBeebies best loved Gardener, brings you a fantastic one-man stage show based on his award-winning TV shows.
            </Paragraph>
            <Paragraph>
              Audiences are entertained and educated by songs, stories and games led by Mr. Bloom himself, helped out by his team of giant inflatable vegetables!
            </Paragraph>
            <Paragraph>
              Perfect for festivals, community events, special occasions and more, headline shows can be tailored to suit your event and are typically 30 minutes long.
            </Paragraph>
            <Paragraph>
              Mr. Bloom meet and greets can also be arranged!
            </Paragraph>
