...
const InteractiveInstallation = ({data}) => (
  <FullWidthPanel maxWidth="64rem"  colours="bg-orange white">
      ...
      <SecondRow>
        <TextWrapper>
          <Paragraph className="fw6">
            The Let’s Grow Nannies invite you to join them in in their beautiful pop-up allotment! Audiences are welcomed into our interactive play space to get stuck into a range of fabulous activities.
          </Paragraph>
          <Paragraph>
            Visitors are encouraged to befriend, feed and care for our adorable baby fruits and vegetables - each of whom has their own unique story and character - and help out with some gardening. There’s a chill out space, lovely toys and a portrait painting area for budding artists too.
          </Paragraph>
          <Paragraph>
            Shows can be tailored for your event. We recommend running up to three 45 minute shows throughout a full day. The setting and all toys and activities are provided as part of the show.
          </Paragraph>
          <Paragraph>
    ...
    <StyledEventContainer>
      ...
      <LargeTextWrapper>
          <Paragraph className="fw6">
            Starting from our Magic Shed, this is a wonderful treasure hunt with a difference!
          </Paragraph>
          <Paragraph>
            The Let’s Grow Fruit and Vegetable Babies are playing Hide & Seek! The experience begins at the Magic Shed where families are given a map, stickers and clues before being sent out on their quest. Big, colourful vinyl stickers or rustic signs of our baby fruits and vegetables are hidden around your event site and families are tasked with finding them all.
          </Paragraph>
          <Paragraph>
            Upon completion it’s back to the Magic Shed to ring the victory bell and be enrolled into the Treasure Hunter Hall of Fame!
          </Paragraph>
          <Paragraph>
            With a bounty of imaginative, interactive features, the Magic Shed really lives up to its name. The friendly Let’s Grow Nannies manage its various quirks and idiosyncrasies to the delight of visitors, of all ages!
          </Paragraph>
          <Paragraph>
            The Let’s Grow team do all the work and visit your site ahead of the event to plan the hunt. An enchanting experience with fun for all the family.
          </Paragraph>
      </LargeTextWrapper>        
    </StyledEventContainer>
    <ButtonContainer>
