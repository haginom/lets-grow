  ...
  <FullWidthPanel isIntro={"true"} colours="bg-pink white" maxWidth="60rem">
    <StyledLayout className="ml4-l">
      <Paragraph className="fw7">
        Welcome to Let’s Grow, brought to you by Ben Faulks, the award winning
        co-creator and presenter of ‘Mr. Bloom’s Nursery’ as seen on CBeebies.
      </Paragraph>

      <Paragraph>
        Let’s Grow brings to life an irresistible world of funky allotments and
        adorable baby fruits and vegetables. Little learners become immersed in
        nature and imaginative play exploring the wonderful themes of gardening,
        growing, nurture and healthy eating.
      </Paragraph>
      ...
      <Paragraph>Read on to learn more!</Paragraph>
    </StyledLayout>
